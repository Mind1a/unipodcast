...
import aboutUs1 from "../../../public/assets/images/aboutUs/aboutUs1.png";
import aboutUs2 from "../../../public/assets/images/aboutUs/aboutUs2.png";
      ...
      >
        <div className="w-full max-w-[492px]">
          <h2
            ...
            className="mb-4 text-[40px] font-bold text-[#FED403] lg:mb-[18px] font-display"
          >
            <LgvBebasText>ვინ ვართ ჩვენ</LgvBebasText>
          </h2>
