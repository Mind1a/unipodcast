...
const BecomeSpeaker = () => {
    ...
    return (
        <div className="w-full lg:p-[120px_24px_112px] p-[32px_24px_80px] md:bg-[#0F011D] bg-[#000000] text-[#FBF4FF] flex flex-col items-center">
            <h2 className="hidden lg:block mb-[87.86px] font-bold leading-[100%] text-[32px]">
                {"გახდი ჩვენი სპიკერი".toUpperCase()}
            </h2>
            ...
            <div className="flex flex-col lg:gap-[263.14px] md:gap-12 gap-6 max-w-310 w-full">
                ...
                <div className="flex md:flex-row flex-col justify-between md:items-center lg:h-71.5 md:h-52 h-96 lg:pr-[132.42px] md:pr-13.75">
                    ...
                    <div className="lg:w-137 md:w-111.25 flex flex-col gap-4.5 relative ">
                        <h3 className="lg:text-[24px] text-[20px] leading-10 font-bold z-10">გაქვს ისტორია, გამოცდილება ან იდეა, რომელიც სხვებს შთააგონებს?</h3>
                        <p className="lg:text-[16px] text-[14px] leading-8 z-10">ჩვენ ვეძებთ ადამიანებს, რომლებიც არ უშინდებიან აზრის გამოხატვას და სურთ რეალური ღირებულების შექმნა.</p>
                    ...
                    <Image alt="Rocket" src={Rocket} width={271.58} height={248} className="lg:w-[271.58px] md:w-37.25 w-33.25 lg:h-62 h-34" />
                ...
                <div className="flex md:flex-row flex-col justify-between lg:h-105.5 md:h-64.5 h-113.75 relative">
                    <div className="lg:w-104.75 md:w-81.25 flex flex-col gap-6 order-1 md:order-0">
                        <h3 className="lg:text-[24px] text-[20px] leading-9.25 font-bold">გახდი უნიპოდასტის სპიკერი</h3>

                        <p className="lg:text-[16px] text-[14px] leading-8">გააზიარე შენი ხმა ფართო აუდიტორიასთან. შეავსე ფორმა ჩვენი გუნდი 24 საათის განმავლობაში დაგიკავშირდება.</p>

                        <button onClick={openModal} className="border border-[#FED403] bg-[#000000] w-81 h-16 rounded-[77px] z-10 p-3.5 text-[#FED403] text-[18px] font-semibold cursor-pointer flex items-center mt-2 order-3 md:order-0">
                    ...
                    <Image alt="Support" src={Support} width={421} height={400} className="md:absolute block lg:-top-19 top-0 lg:right-22.75 right-0 lg:w-105.25 w-89.75 lg:h-100 h-64.5 order-2 md:order-0" />
                </div>
            </div>
        </div>
    )
