        ...
        >
            {isOpen && (
                ...
                >
                    ...
                    >
                        <button onClick={handleClose} className="cursor-pointer mb-4 flex justify-end" ><Image alt="close" src={CloseBtn} width={32} height={32} /></button>

                        {submitted ? (
                            <div className="z-10 bg-[#1E1D2E] flex flex-col gap-6 items-center justify-center">
                                <h2 className="font-bold md:text-[54px] text-[26px] leading-100% tracking-[1.51px] font-display text-center">
                                    <span className="md:block hidden"><LgvBebasText>წარმატებით გადაგზავნილია</LgvBebasText></span>
                                    <span className="md:hidden block font-sans">წარმატებით გადაგზავნილია</span>
                                </h2>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="z-10 bg-[#500794] rounded-4xl flex flex-col p-12 gap-4">
                                <div className="h-1 bg-[#D9D9D9] rounded-4xl mb-2" />
