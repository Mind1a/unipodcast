    ...
    >
      ...
      <span className="shrink-0 group-hover:rotate-z-45 duration-200 rounded-full border group-hover:border-black  border-[#FED403] p-[8.5px]">
        <svg  width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path className="group-hover:fill-black " d="M4.02492 10.5833L3.20825 9.76667L8.80825 4.16667H3.79159V3H10.7916V10H9.62492V4.98333L4.02492 10.5833Z" fill="#FED403" />
        </svg>
      </span>
    </button>
  )
      ...
      >
        ...
        <div
          className={`flex h-full flex-1 mt-[clamp(50px,3vw,12px)]
            xl:mt-2
ml-[clamp(6px,2vw,12px)]   flex-col justify-start text-white sm:order-1  xl:justify-end xl:pb-3 ${isSecondCard
...
xl:mb-5 flex flex-col gap-0.5 sm:mb-14 sm:gap-1  ${isSecondCard ? "xl:items-end" : ""
              }`}
          >
...
h-[clamp(40px,12vw,80px)] cursor-pointer items-center justify-center rounded-full border border-[#FED403]  transition-colors duration-300  sm:hidden"
        >
          <span className="flex w-[clamp(34px,8vw,40px)]
